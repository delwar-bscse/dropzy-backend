...
router.post('/change-password', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.COURIER, user_1.USER_ROLES.SENDER), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.createChangePasswordZodSchema), auth_controller_1.AuthController.changePassword);
router.post('/resend-otp', auth_controller_1.AuthController.resendVerificationEmail);
router.delete('/delete-account', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.COURIER, user_1.USER_ROLES.SENDER), auth_controller_1.AuthController.deleteUser);
router.patch('/swap-role', (0, auth_1.default)(user_1.USER_ROLES.COURIER, user_1.USER_ROLES.SENDER), auth_controller_1.AuthController.swapUserRole);
