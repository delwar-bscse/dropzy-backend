...
exports.getSingleFilePathDocument = exports.getMultipleFilesPath = exports.getSingleFilePath = void 0;
...
const getSingleFilePathDocument = (files, folderName) => {
    const fileField = files && files[folderName];
    if (fileField && Array.isArray(fileField) && fileField.length > 0) {
...
exports.getSingleFilePathDocument = getSingleFilePathDocument;
//multiple files
